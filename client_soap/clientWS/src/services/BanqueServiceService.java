 ...
 * 
 */
@WebServiceClient(name = "banqueServiceService", targetNamespace = "http://services/", wsdlLocation = "http://localhost:1992/BanqueWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANQUESERVICESERVICE_QNAME = new QName("http://services/", "banqueServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:1992/BanqueWS?wsdl");
